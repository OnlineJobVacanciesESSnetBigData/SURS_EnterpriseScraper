...
# Url whitelist.
with open("/home/STATISTIKA/grahonja/WinFolders/Q/Big_Data/Spletne_strani_podjetij/Python"
          "/kljucne_besede/url_whitelist.txt", "r+", encoding="latin1") as kw:
...
with open("/home/STATISTIKA/grahonja/WinFolders/Q/Big_Data/Spletne_strani_podjetij/Python"
          "/kljucne_besede/tab_whitelist.txt", "r+", encoding="latin1") as kw:
...
"""with open("/home/STATISTIKA/grahonja/WinFolders/Q/Big_Data/Spletne_strani_podjetij/Python"
          "/kljucne_besede/occupations_url.txt", "r+", encoding="utf8") as occ_url:
...
class JobSpider(scrapy.Spider):
    ...
    with open("/home/STATISTIKA/grahonja/WinFolders/Q/Big_Data/Spletne_strani_podjetij/IKT/urls_leto_2018.txt", "r+") \
            as urls_file:
    ...
    def spider_startinfo(self, spider):
        print("Začenja se iskanje relevantnih strani...\n")
    ...
    def spider_endinfo(self, spider):
        ...
        if str(len(spider.jobs_urls)).endswith("01") or len(spider.jobs_urls) == 1:
            print("\n\nIskanje končano, najdena %d relevantna stran." % len(spider.jobs_urls))
        elif str(len(spider.jobs_urls)).endswith("02")or len(spider.jobs_urls) == 2:
            print("\n\nIskanje končano, najdeni %d relevantni strani." % len(spider.jobs_urls))
        elif str(len(spider.jobs_urls)).endswith("03") or str(len(spider.jobs_urls)).endswith("04")\
                or len(spider.jobs_urls) in (3, 4):
            print("\n\nIskanje končano, najdene %d relevantne strani." % len(spider.jobs_urls))
        else:
            print("\n\nIskanje končano, najdenih %d relevantnih strani" % len(spider.jobs_urls))
        print("Preteklo je %02d:%02d:%02d časa.\n\n" % (end_time//3600, end_time//60 - (end_time//3600)*60,
